...
import { ScrapingBotFindManyArgs } from "../../scrapingBot/base/ScrapingBotFindManyArgs";
...
export class BotControllerBase {
  ...
  async findScrapingBots(
    @common.Req() request: Request,
    @common.Param() params: BotWhereUniqueInput
  ): Promise<ScrapingBot[]> {
    const query = plainToClass(ScrapingBotFindManyArgs, request.query);
    const results = await this.service.findScrapingBots(params.id, {
      ...query,
      select: {
        bot: {
          select: {
  ...
  @common.Post("/:id/scrapingBots")
  @nestAccessControl.UseRoles({
    resource: "Bot",
    action: "update",
    possession: "any",
  })
  async connectScrapingBots(
    @common.Param() params: BotWhereUniqueInput,
    @common.Body() body: ScrapingBotWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      scrapingBots: {
        connect: body,
  ...
  @common.Patch("/:id/scrapingBots")
  @nestAccessControl.UseRoles({
    resource: "Bot",
    action: "update",
    possession: "any",
  })
  async updateScrapingBots(
    @common.Param() params: BotWhereUniqueInput,
    @common.Body() body: ScrapingBotWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/scrapingBots")
  @nestAccessControl.UseRoles({
    resource: "Bot",
    action: "update",
    possession: "any",
  })
  async disconnectScrapingBots(
    @common.Param() params: BotWhereUniqueInput,
    @common.Body() body: ScrapingBotWhereUniqueInput[]
  ): Promise<void> {
    const data = {
